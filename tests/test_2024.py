...
def test_day_22():
    from y2024.d22 import solve

    res1, res2 = solve(load_input_data(2024, 22))

    assert res1 == 21_147_129_593, f"Part1 = {res1}"
    assert res2 == 2_445, f"Part2 = {res2}"


def test_day_23():
    from y2024.d23 import solve

    res1, res2 = solve(load_input_data(2024, 23))

    assert res1 == 1_306, f"Part1 = {res1}"
    assert res2 == "bd,dk,ir,ko,lk,nn,ob,pt,te,tl,uh,wj,yl", f"Part2 = {res2}"


def test_day_24():
    from y2024.d24 import solve

    res1, res2 = solve(load_input_data(2024, 24))

    assert res1 == 55_920_211_035_878, f"Part1 = {res1}"
    assert res2 == "btb,cmv,mwp,rdg,rmj,z17,z23,z30", f"Part2 = {res2}"


def test_day_25():
    from y2024.d25 import solve

    res1 = solve(load_input_data(2024, 25))

    assert res1 == 2_770, f"Part1 = {res1}"
