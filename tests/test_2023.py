...
def test_day_01(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202301.txt")
...
def test_day_02(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202302.txt")
...
def test_day_03(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202303.txt")
...
def test_day_04(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202304.txt")
...
def test_day_05(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202305.txt")
...
def test_day_06(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202306.txt")
...
def test_day_07(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202307.txt")
...
def test_day_08(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202308.txt")
...
def test_day_09(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202309.txt")
...
def test_day_10(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202310.txt")
...
def test_day_11(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202311.txt")
...
def test_day_12(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202312.txt")
...
def test_day_13(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202313.txt")
...
def test_day_14(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202314.txt")
...
def test_day_15(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202315.txt")
...
def test_day_16(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202316.txt")
...
def test_day_17(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202317.txt")
...
def test_day_18(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202318.txt")
...
def test_day_19(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202319.txt")
...
def test_day_20(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202320.txt")
...
def test_day_21(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202321.txt")
...
def test_day_22(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202322.txt")
...
def test_day_23(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202323.txt")
...
def test_day_24(data_dir: Path):
    ...
    res1, res2 = solve(data_dir / "202324.txt")
